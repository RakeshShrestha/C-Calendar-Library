...
@echo Create binary
clang -I "Generated Files" -D_WINDOWS -DUNICODE -D_UNICODE main.cpp -Xclang -std=c++17 -Xclang -Wno-delete-non-virtual-dtor -fcoroutines-ts -o build\mysample.exe -L "%WINDOWS_SDK%\um\x64" -Wl,kernel32.lib,user32.lib,windowsapp.lib
