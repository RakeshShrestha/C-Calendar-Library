...
build_time_vars = {'ABIFLAGS': '',
 ...
 'BASEMODLIBS': '',
 'BINDIR': '/opt/llvm-mingw-x86_64/python/bin',
 'BINLIBDEST': '/opt/llvm-mingw-x86_64/python/lib/python3.9',
 'BLDLIBRARY': '-L. -lpython3.9',
 'BLDSHARED': 'x86_64-w64-mingw32-clang -shared -Wl,--enable-auto-image-base '
              '-L/opt/llvm-mingw-x86_64/python/lib -Wl,-s',
 'BUILDEXE': '.exe',
 ...
 'CFLAGS': '-Wno-unused-result -Wsign-compare -Wunreachable-code -DNDEBUG -g '
           '-fwrapv -O3 -Wall -I/opt/llvm-mingw-x86_64/python/include',
 'CFLAGSFORSHARED': '',
 'CFLAGS_ALIASING': '-fno-strict-aliasing',
 'CFLAGS_NODIST': '',
 'CONFIGFILES': 'configure configure.ac acconfig.h pyconfig.h.in '
                'Makefile.pre.in',
 'CONFIGURE_CFLAGS': '-I/opt/llvm-mingw-x86_64/python/include',
 ...
 'CONFIGURE_LDFLAGS': '-L/opt/llvm-mingw-x86_64/python/lib -Wl,-s',
 'CONFIGURE_LDFLAGS_NODIST': '',
 'CONFIG_ARGS': "'--prefix=/opt/llvm-mingw-x86_64/python' "
                "'--build=x86_64-pc-linux-gnu' '--host=x86_64-w64-mingw32' "
                "'CFLAGS=-I/opt/llvm-mingw-x86_64/python/include' "
                "'CXXFLAGS=-I/opt/llvm-mingw-x86_64/python/include' "
                "'LDFLAGS=-L/opt/llvm-mingw-x86_64/python/lib -Wl,-s' "
                "'--enable-shared' '--with-system-ffi' '--without-ensurepip' "
                "'--without-c-locale-coercion' "
                "'build_alias=x86_64-pc-linux-gnu' "
                "'host_alias=x86_64-w64-mingw32' 'CC=x86_64-w64-mingw32-clang'",
 'CONFINCLUDEDIR': '/opt/llvm-mingw-x86_64/python/include',
 'CONFINCLUDEPY': '/opt/llvm-mingw-x86_64/python/include/python3.9',
 'COREPYTHONPATH': '',
 'COVERAGE_INFO': '/build/cpython-mingw/build-x86_64-w64-mingw32/coverage.info',
 'COVERAGE_REPORT': '/build/cpython-mingw/build-x86_64-w64-mingw32/lcov-report',
 ...
 'DESTDIR': '',
 'DESTDIRFINAL': '/',
 'DESTDIRS': '/opt/llvm-mingw-x86_64/python /opt/llvm-mingw-x86_64/python/lib '
             '/opt/llvm-mingw-x86_64/python/lib/python3.9 '
             '/opt/llvm-mingw-x86_64/python/lib/python3.9/lib-dynload',
 'DESTLIB': '/opt/llvm-mingw-x86_64/python/lib/python3.9',
 'DESTPATH': '',
 'DESTSHARED': '/opt/llvm-mingw-x86_64/python/lib/python3.9/lib-dynload',
 'DFLAGS': '',
 'DIRMODE': 755,
 ...
 'EXTRATESTOPTS': '',
 'EXTRA_CFLAGS': '',
 'EXT_SUFFIX': '.cp39-mingw_x86_64_clang.pyd',
 'FILEMODE': 644,
 ...
 'INCLDIRSTOMAKE': '/opt/llvm-mingw-x86_64/python/include '
                   '/opt/llvm-mingw-x86_64/python/include '
                   '/opt/llvm-mingw-x86_64/python/include/python3.9 '
                   '/opt/llvm-mingw-x86_64/python/include/python3.9',
 'INCLUDEDIR': '/opt/llvm-mingw-x86_64/python/include',
 'INCLUDEPY': '/opt/llvm-mingw-x86_64/python/include/python3.9',
 ...
 'LDLIBRARYDIR': '',
 'LDSHARED': 'x86_64-w64-mingw32-clang -shared -Wl,--enable-auto-image-base '
             '-L/opt/llvm-mingw-x86_64/python/lib -Wl,-s',
 'LDVERSION': '3.9',
 'LIBC': '',
 'LIBDEST': '/opt/llvm-mingw-x86_64/python/lib/python3.9',
 'LIBDIR': '/opt/llvm-mingw-x86_64/python/lib',
 'LIBFFI_INCLUDEDIR': '',
 'LIBM': '-lm',
 'LIBOBJDIR': 'Python/',
 'LIBOBJS': '',
 'LIBPC': '/opt/llvm-mingw-x86_64/python/lib/pkgconfig',
 'LIBPL': '/opt/llvm-mingw-x86_64/python/lib/python3.9/config-3.9',
 ...
 'LINKCC': 'x86_64-w64-mingw32-clang',
 'LINKFORSHARED': '-Wl,--stack,2000000',
 'LIPO_32BIT_FLAGS': '',
 'LIPO_INTEL64_FLAGS': '',
 'LLVM_PROF_ERR': 'no',
 'LLVM_PROF_FILE': 'LLVM_PROFILE_FILE="code-%p.profclangr"',
 'LLVM_PROF_MERGER': '/opt/llvm-mingw/bin/llvm-profdata merge '
                     '-output=code.profclangd *.profclangr',
 'LN': 'ln',
 'LOCALMODLIBS': '-lws2_32',
 'MACHDEP': 'win32',
 'MACHDEP_OBJS': 'PC/dl_nt.o',
 'MACHDESTLIB': '/opt/llvm-mingw-x86_64/python/lib/python3.9',
 'MACOSX_DEPLOYMENT_TARGET': '',
 'MAINCC': 'x86_64-w64-mingw32-clang',
 'MAJOR_IN_MKDEV': 0,
 'MAJOR_IN_SYSMACROS': 0,
 'MAKESETUP': '../Modules/makesetup',
 'MANDIR': '/opt/llvm-mingw-x86_64/python/share/man',
 'MKDIR_P': '/bin/mkdir -p',
 ...
 'MODOBJS': 'Modules/posixmodule.o  Modules/winreg.o  Modules/msvcrtmodule.o  '
            ...
            'Modules/xxsubtype.o',
 'MODULE_OBJS': '\\',
 'MULTIARCH': 'x86_64-w64-windows-gnu',
 'MULTIARCH_CPPFLAGS': '-DMULTIARCH=\\"x86_64-w64-windows-gnu\\"',
 ...
 'PYTHONPATH': '',
 'PYTHON_FOR_BUILD': '_PYTHON_PROJECT_BASE=/build/cpython-mingw/build-x86_64-w64-mingw32 '
                     '_PYTHON_HOST_PLATFORM=$(_PYTHON_HOST_PLATFORM) '
                     'PYTHONPATH=$(shell test -f pybuilddir.txt && echo '
                     '/build/cpython-mingw/build-x86_64-w64-mingw32/`cat '
                     'pybuilddir.txt`:)../Lib '
                     '_PYTHON_SYSCONFIGDATA_NAME=_sysconfigdata__win32_x86_64-w64-windows-gnu '
                     'python3.9',
 'PYTHON_HEADERS': '\\',
 'PYTHON_OBJS': '\\',
 ...
 'PY_BUILTIN_MODULE_CFLAGS': '-Wno-unused-result -Wsign-compare '
                             ...
                             '-I/opt/llvm-mingw-x86_64/python/include -std=c99 '
 ...
 'PY_CFLAGS': '-Wno-unused-result -Wsign-compare -Wunreachable-code -DNDEBUG '
              '-g -fwrapv -O3 -Wall -I/opt/llvm-mingw-x86_64/python/include',
 ...
 'PY_CORE_CFLAGS': '-Wno-unused-result -Wsign-compare -Wunreachable-code '
                   ...
                   '-I/opt/llvm-mingw-x86_64/python/include -std=c99 -Wextra '
 ...
 'PY_CORE_LDFLAGS': '-L/opt/llvm-mingw-x86_64/python/lib -Wl,-s',
 'PY_CPPFLAGS': '-IObjects -IInclude -IPython -I. -I../Include -I../PC  -I.',
 'PY_FORMAT_SIZE_T': 0,
 'PY_LDFLAGS': '-L/opt/llvm-mingw-x86_64/python/lib -Wl,-s',
 'PY_LDFLAGS_NODIST': '',
 ...
 'RCFLAGS': '-DFIELD3=0 -O COFF --target=pe-x86-64',
 'READELF': 'x86_64-w64-mingw32-readelf',
 'RESSRCDIR': 'Mac/Resources/framework',
 'RETSIGTYPE': 'void',
 'RUNSHARED': '',
 'SCRIPTDIR': '/opt/llvm-mingw-x86_64/python/lib',
 'SETPGRP_HAVE_ARG': 0,
 'SHELL': '/bin/sh',
 ...
 'VENVLAUNCHERDIR': '/opt/llvm-mingw-x86_64/python/lib/python3.9/venv/scripts/nt',
 'VERSION': '3.9',
 'VPATH': '/build/cpython-mingw',
 'VPATH_b2h': '/build/cpython-mingw',
 'WINDOW_HAS_FLAGS': 0,
 ...
 'abs_builddir': '/build/cpython-mingw/build-x86_64-w64-mingw32',
 'abs_builddir_b2h': '/build/cpython-mingw/build-x86_64-w64-mingw32',
 'abs_srcdir': '/build/cpython-mingw',
 'abs_srcdir_b2h': '/build/cpython-mingw',
 'datarootdir': '/opt/llvm-mingw-x86_64/python/share',
 'exec_prefix': '/opt/llvm-mingw-x86_64/python',
 'prefix': '/opt/llvm-mingw-x86_64/python',
 'prefix_b2h': '/opt/llvm-mingw-x86_64/python',
 'srcdir': '/build/cpython-mingw',
 'srcdir_b2h': '/build/cpython-mingw'}
