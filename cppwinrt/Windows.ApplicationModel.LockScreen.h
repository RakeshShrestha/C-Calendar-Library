...
WINRT_EXPORT namespace winrt::Windows::ApplicationModel::LockScreen
{
    ...
    {
        return impl::call_factory_cast<Windows::ApplicationModel::LockScreen::LockApplicationHost(*)(ILockApplicationHostStatics const&), LockApplicationHost, ILockApplicationHostStatics>([](ILockApplicationHostStatics const& f) { return f.GetForCurrentView(); });
    }
}
namespace std
{
