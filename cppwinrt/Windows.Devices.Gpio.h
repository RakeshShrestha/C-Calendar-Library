...
{
    template <typename D> WINRT_IMPL_AUTO(void) consume_Windows_Devices_Gpio_IGpioChangeCounter<D>::Polarity(Windows::Devices::Gpio::GpioChangePolarity const& value) const
    {
        check_hresult(WINRT_IMPL_SHIM(Windows::Devices::Gpio::IGpioChangeCounter)->put_Polarity(static_cast<int32_t>(value)));
    }
    template <typename D> WINRT_IMPL_AUTO(Windows::Devices::Gpio::GpioChangePolarity) consume_Windows_Devices_Gpio_IGpioChangeCounter<D>::Polarity() const
    {
        Windows::Devices::Gpio::GpioChangePolarity value{};
        check_hresult(WINRT_IMPL_SHIM(Windows::Devices::Gpio::IGpioChangeCounter)->get_Polarity(reinterpret_cast<int32_t*>(&value)));
        return value;
    }
    ...
    template <typename D> WINRT_IMPL_AUTO(Windows::Devices::Gpio::GpioChangeCount) consume_Windows_Devices_Gpio_IGpioChangeCounter<D>::Read() const
    {
    ...
    template <typename D> WINRT_IMPL_AUTO(Windows::Devices::Gpio::GpioChangeCount) consume_Windows_Devices_Gpio_IGpioChangeCounter<D>::Reset() const
    {
        Windows::Devices::Gpio::GpioChangeCount value{};
        check_hresult(WINRT_IMPL_SHIM(Windows::Devices::Gpio::IGpioChangeCounter)->Reset(put_abi(value)));
        return value;
    }
    template <typename D> WINRT_IMPL_AUTO(Windows::Devices::Gpio::GpioChangeCounter) consume_Windows_Devices_Gpio_IGpioChangeCounterFactory<D>::Create(Windows::Devices::Gpio::GpioPin const& pin) const
    {
        void* value{};
    ...
    template <typename D> WINRT_IMPL_AUTO(void) consume_Windows_Devices_Gpio_IGpioChangeReader<D>::Polarity(Windows::Devices::Gpio::GpioChangePolarity const& value) const
    {
        check_hresult(WINRT_IMPL_SHIM(Windows::Devices::Gpio::IGpioChangeReader)->put_Polarity(static_cast<int32_t>(value)));
    }
    template <typename D> WINRT_IMPL_AUTO(Windows::Devices::Gpio::GpioChangePolarity) consume_Windows_Devices_Gpio_IGpioChangeReader<D>::Polarity() const
    {
        Windows::Devices::Gpio::GpioChangePolarity value{};
        check_hresult(WINRT_IMPL_SHIM(Windows::Devices::Gpio::IGpioChangeReader)->get_Polarity(reinterpret_cast<int32_t*>(&value)));
        return value;
    }
    ...
    template <typename D> WINRT_IMPL_AUTO(Windows::Devices::Gpio::GpioChangeRecord) consume_Windows_Devices_Gpio_IGpioChangeReader<D>::GetNextItem() const
    {
    ...
    template <typename D> WINRT_IMPL_AUTO(Windows::Devices::Gpio::GpioChangeRecord) consume_Windows_Devices_Gpio_IGpioChangeReader<D>::PeekNextItem() const
    {
        Windows::Devices::Gpio::GpioChangeRecord value{};
        check_hresult(WINRT_IMPL_SHIM(Windows::Devices::Gpio::IGpioChangeReader)->PeekNextItem(put_abi(value)));
        return value;
    }
    template <typename D> WINRT_IMPL_AUTO(Windows::Foundation::Collections::IVector<Windows::Devices::Gpio::GpioChangeRecord>) consume_Windows_Devices_Gpio_IGpioChangeReader<D>::GetAllItems() const
    {
        void* value{};
    ...
    template <typename D> WINRT_IMPL_AUTO(Windows::Foundation::IAsyncAction) consume_Windows_Devices_Gpio_IGpioChangeReader<D>::WaitForItemsAsync(int32_t count) const
    {
        void* operation{};
        check_hresult(WINRT_IMPL_SHIM(Windows::Devices::Gpio::IGpioChangeReader)->WaitForItemsAsync(count, &operation));
        return Windows::Foundation::IAsyncAction{ operation, take_ownership_from_abi };
    }
    template <typename D> WINRT_IMPL_AUTO(Windows::Devices::Gpio::GpioChangeReader) consume_Windows_Devices_Gpio_IGpioChangeReaderFactory<D>::Create(Windows::Devices::Gpio::GpioPin const& pin) const
    {
        void* value{};
    ...
    template <typename D> WINRT_IMPL_AUTO(Windows::Devices::Gpio::GpioChangeReader) consume_Windows_Devices_Gpio_IGpioChangeReaderFactory<D>::CreateWithCapacity(Windows::Devices::Gpio::GpioPin const& pin, int32_t minCapacity) const
    {
        void* value{};
    ...
    template <typename D> WINRT_IMPL_AUTO(Windows::Devices::Gpio::GpioPin) consume_Windows_Devices_Gpio_IGpioController<D>::OpenPin(int32_t pinNumber) const
    {
        void* pin{};
    ...
    template <typename D> WINRT_IMPL_AUTO(Windows::Devices::Gpio::GpioPin) consume_Windows_Devices_Gpio_IGpioController<D>::OpenPin(int32_t pinNumber, Windows::Devices::Gpio::GpioSharingMode const& sharingMode) const
    {
        void* pin{};
    ...
    template <typename D> WINRT_IMPL_AUTO(bool) consume_Windows_Devices_Gpio_IGpioController<D>::TryOpenPin(int32_t pinNumber, Windows::Devices::Gpio::GpioSharingMode const& sharingMode, Windows::Devices::Gpio::GpioPin& pin, Windows::Devices::Gpio::GpioOpenStatus& openStatus) const
    {
        bool succeeded{};
        check_hresult(WINRT_IMPL_SHIM(Windows::Devices::Gpio::IGpioController)->TryOpenPin(pinNumber, static_cast<int32_t>(sharingMode), impl::bind_out(pin), reinterpret_cast<int32_t*>(&openStatus), &succeeded));
        return succeeded;
    }
    template <typename D> WINRT_IMPL_AUTO(Windows::Devices::Gpio::GpioController) consume_Windows_Devices_Gpio_IGpioControllerStatics<D>::GetDefault() const
    {
        void* value{};
    ...
    template <typename D> WINRT_IMPL_AUTO(Windows::Foundation::IAsyncOperation<Windows::Foundation::Collections::IVectorView<Windows::Devices::Gpio::GpioController>>) consume_Windows_Devices_Gpio_IGpioControllerStatics2<D>::GetControllersAsync(Windows::Devices::Gpio::Provider::IGpioProvider const& provider) const
    {
        void* operation{};
    ...
    template <typename D> WINRT_IMPL_AUTO(Windows::Foundation::IAsyncOperation<Windows::Devices::Gpio::GpioController>) consume_Windows_Devices_Gpio_IGpioControllerStatics2<D>::GetDefaultAsync() const
    {
        void* operation{};
    ...
    template <typename D> WINRT_IMPL_AUTO(winrt::event_token) consume_Windows_Devices_Gpio_IGpioPin<D>::ValueChanged(Windows::Foundation::TypedEventHandler<Windows::Devices::Gpio::GpioPin, Windows::Devices::Gpio::GpioPinValueChangedEventArgs> const& handler) const
    {
    ...
    template <typename D> WINRT_IMPL_AUTO(Windows::Foundation::TimeSpan) consume_Windows_Devices_Gpio_IGpioPin<D>::DebounceTimeout() const
    {
        Windows::Foundation::TimeSpan value{};
        check_hresult(WINRT_IMPL_SHIM(Windows::Devices::Gpio::IGpioPin)->get_DebounceTimeout(put_abi(value)));
        return value;
    }
    template <typename D> WINRT_IMPL_AUTO(void) consume_Windows_Devices_Gpio_IGpioPin<D>::DebounceTimeout(Windows::Foundation::TimeSpan const& value) const
    {
    ...
    template <typename D> WINRT_IMPL_AUTO(Windows::Devices::Gpio::GpioSharingMode) consume_Windows_Devices_Gpio_IGpioPin<D>::SharingMode() const
    {
        Windows::Devices::Gpio::GpioSharingMode value{};
        check_hresult(WINRT_IMPL_SHIM(Windows::Devices::Gpio::IGpioPin)->get_SharingMode(reinterpret_cast<int32_t*>(&value)));
        return value;
    }
    template <typename D> WINRT_IMPL_AUTO(bool) consume_Windows_Devices_Gpio_IGpioPin<D>::IsDriveModeSupported(Windows::Devices::Gpio::GpioPinDriveMode const& driveMode) const
    {
        bool supported{};
        check_hresult(WINRT_IMPL_SHIM(Windows::Devices::Gpio::IGpioPin)->IsDriveModeSupported(static_cast<int32_t>(driveMode), &supported));
        return supported;
    }
    template <typename D> WINRT_IMPL_AUTO(Windows::Devices::Gpio::GpioPinDriveMode) consume_Windows_Devices_Gpio_IGpioPin<D>::GetDriveMode() const
    {
        Windows::Devices::Gpio::GpioPinDriveMode value{};
        check_hresult(WINRT_IMPL_SHIM(Windows::Devices::Gpio::IGpioPin)->GetDriveMode(reinterpret_cast<int32_t*>(&value)));
        return value;
    }
    template <typename D> WINRT_IMPL_AUTO(void) consume_Windows_Devices_Gpio_IGpioPin<D>::SetDriveMode(Windows::Devices::Gpio::GpioPinDriveMode const& value) const
    {
        check_hresult(WINRT_IMPL_SHIM(Windows::Devices::Gpio::IGpioPin)->SetDriveMode(static_cast<int32_t>(value)));
    }
    template <typename D> WINRT_IMPL_AUTO(void) consume_Windows_Devices_Gpio_IGpioPin<D>::Write(Windows::Devices::Gpio::GpioPinValue const& value) const
    {
        check_hresult(WINRT_IMPL_SHIM(Windows::Devices::Gpio::IGpioPin)->Write(static_cast<int32_t>(value)));
    }
    template <typename D> WINRT_IMPL_AUTO(Windows::Devices::Gpio::GpioPinValue) consume_Windows_Devices_Gpio_IGpioPin<D>::Read() const
    {
        Windows::Devices::Gpio::GpioPinValue value{};
        check_hresult(WINRT_IMPL_SHIM(Windows::Devices::Gpio::IGpioPin)->Read(reinterpret_cast<int32_t*>(&value)));
        return value;
    }
    template <typename D> WINRT_IMPL_AUTO(Windows::Devices::Gpio::GpioPinEdge) consume_Windows_Devices_Gpio_IGpioPinValueChangedEventArgs<D>::Edge() const
    {
        Windows::Devices::Gpio::GpioPinEdge value{};
        check_hresult(WINRT_IMPL_SHIM(Windows::Devices::Gpio::IGpioPinValueChangedEventArgs)->get_Edge(reinterpret_cast<int32_t*>(&value)));
        return value;
    }
...
WINRT_EXPORT namespace winrt::Windows::Devices::Gpio
{
    ...
    {
        return impl::call_factory_cast<Windows::Devices::Gpio::GpioController(*)(IGpioControllerStatics const&), GpioController, IGpioControllerStatics>([](IGpioControllerStatics const& f) { return f.GetDefault(); });
    }
    ...
    {
        return impl::call_factory_cast<Windows::Foundation::IAsyncOperation<Windows::Devices::Gpio::GpioController>(*)(IGpioControllerStatics2 const&), GpioController, IGpioControllerStatics2>([](IGpioControllerStatics2 const& f) { return f.GetDefaultAsync(); });
    }
}
namespace std
{
