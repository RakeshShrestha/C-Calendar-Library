...
namespace winrt::impl
{
    ...
    {
        double value{};
        check_hresult(WINRT_IMPL_SHIM(Windows::Media::Effects::ISlowMotionEffectDefinition)->get_TimeStretchRate(&value));
        return value;
    }
    ...
    {
        check_hresult(WINRT_IMPL_SHIM(Windows::Media::Effects::ISlowMotionEffectDefinition)->put_TimeStretchRate(value));
    }
...
WINRT_EXPORT namespace winrt::Windows::Media::Effects
{
    ...
    inline SlowMotionEffectDefinition::SlowMotionEffectDefinition() :
        SlowMotionEffectDefinition(impl::call_factory_cast<SlowMotionEffectDefinition(*)(Windows::Foundation::IActivationFactory const&), SlowMotionEffectDefinition>([](Windows::Foundation::IActivationFactory const& f) { return f.template ActivateInstance<SlowMotionEffectDefinition>(); }))
    {
    }
