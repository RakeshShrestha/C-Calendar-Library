...
{
    template <typename D> WINRT_IMPL_AUTO(Windows::Phone::ApplicationModel::ApplicationProfileModes) consume_Windows_Phone_ApplicationModel_IApplicationProfileStatics<D>::Modes() const
    {
        Windows::Phone::ApplicationModel::ApplicationProfileModes value{};
        check_hresult(WINRT_IMPL_SHIM(Windows::Phone::ApplicationModel::IApplicationProfileStatics)->get_Modes(reinterpret_cast<uint32_t*>(&value)));
        return value;
    }
...
WINRT_EXPORT namespace winrt::Windows::Phone::ApplicationModel
{
    ...
    {
        return impl::call_factory_cast<Windows::Phone::ApplicationModel::ApplicationProfileModes(*)(IApplicationProfileStatics const&), ApplicationProfile, IApplicationProfileStatics>([](IApplicationProfileStatics const& f) { return f.Modes(); });
    }
}
namespace std
{
