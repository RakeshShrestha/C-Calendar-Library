...
{
    template <typename D> WINRT_IMPL_AUTO(void) consume_Windows_Phone_Devices_Notification_IVibrationDevice<D>::Vibrate(Windows::Foundation::TimeSpan const& duration) const
    {
        check_hresult(WINRT_IMPL_SHIM(Windows::Phone::Devices::Notification::IVibrationDevice)->Vibrate(impl::bind_in(duration)));
    }
    template <typename D> WINRT_IMPL_AUTO(void) consume_Windows_Phone_Devices_Notification_IVibrationDevice<D>::Cancel() const
    {
        check_hresult(WINRT_IMPL_SHIM(Windows::Phone::Devices::Notification::IVibrationDevice)->Cancel());
    }
    template <typename D> WINRT_IMPL_AUTO(Windows::Phone::Devices::Notification::VibrationDevice) consume_Windows_Phone_Devices_Notification_IVibrationDeviceStatics<D>::GetDefault() const
    {
        void* result{};
        check_hresult(WINRT_IMPL_SHIM(Windows::Phone::Devices::Notification::IVibrationDeviceStatics)->GetDefault(&result));
        return Windows::Phone::Devices::Notification::VibrationDevice{ result, take_ownership_from_abi };
    }
    ...
    struct produce<D, Windows::Phone::Devices::Notification::IVibrationDeviceStatics> : produce_base<D, Windows::Phone::Devices::Notification::IVibrationDeviceStatics>
    {
        int32_t __stdcall GetDefault(void** result) noexcept final try
        {
            clear_abi(result);
            typename D::abi_guard guard(this->shim());
            *result = detach_from<Windows::Phone::Devices::Notification::VibrationDevice>(this->shim().GetDefault());
            return 0;
        }
        catch (...) { return to_hresult(); }
    };
...
WINRT_EXPORT namespace winrt::Windows::Phone::Devices::Notification
{
    ...
    {
        return impl::call_factory_cast<Windows::Phone::Devices::Notification::VibrationDevice(*)(IVibrationDeviceStatics const&), VibrationDevice, IVibrationDeviceStatics>([](IVibrationDeviceStatics const& f) { return f.GetDefault(); });
    }
}
namespace std
{
