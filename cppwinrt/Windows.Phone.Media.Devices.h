...
{
    template <typename D> WINRT_IMPL_AUTO(Windows::Phone::Media::Devices::AudioRoutingEndpoint) consume_Windows_Phone_Media_Devices_IAudioRoutingManager<D>::GetAudioEndpoint() const
    {
        Windows::Phone::Media::Devices::AudioRoutingEndpoint endpoint{};
        check_hresult(WINRT_IMPL_SHIM(Windows::Phone::Media::Devices::IAudioRoutingManager)->GetAudioEndpoint(reinterpret_cast<int32_t*>(&endpoint)));
        return endpoint;
    }
    template <typename D> WINRT_IMPL_AUTO(void) consume_Windows_Phone_Media_Devices_IAudioRoutingManager<D>::SetAudioEndpoint(Windows::Phone::Media::Devices::AudioRoutingEndpoint const& endpoint) const
    {
        check_hresult(WINRT_IMPL_SHIM(Windows::Phone::Media::Devices::IAudioRoutingManager)->SetAudioEndpoint(static_cast<int32_t>(endpoint)));
    }
    template <typename D> WINRT_IMPL_AUTO(winrt::event_token) consume_Windows_Phone_Media_Devices_IAudioRoutingManager<D>::AudioEndpointChanged(Windows::Foundation::TypedEventHandler<Windows::Phone::Media::Devices::AudioRoutingManager, Windows::Foundation::IInspectable> const& endpointChangeHandler) const
    {
        winrt::event_token token{};
        check_hresult(WINRT_IMPL_SHIM(Windows::Phone::Media::Devices::IAudioRoutingManager)->add_AudioEndpointChanged(*(void**)(&endpointChangeHandler), put_abi(token)));
        return token;
    }
    ...
    {
        WINRT_VERIFY_(0, WINRT_IMPL_SHIM(Windows::Phone::Media::Devices::IAudioRoutingManager)->remove_AudioEndpointChanged(impl::bind_in(token)));
    }
    template <typename D> WINRT_IMPL_AUTO(Windows::Phone::Media::Devices::AvailableAudioRoutingEndpoints) consume_Windows_Phone_Media_Devices_IAudioRoutingManager<D>::AvailableAudioEndpoints() const
    {
        Windows::Phone::Media::Devices::AvailableAudioRoutingEndpoints value{};
        check_hresult(WINRT_IMPL_SHIM(Windows::Phone::Media::Devices::IAudioRoutingManager)->get_AvailableAudioEndpoints(reinterpret_cast<uint32_t*>(&value)));
        return value;
    }
    template <typename D> WINRT_IMPL_AUTO(Windows::Phone::Media::Devices::AudioRoutingManager) consume_Windows_Phone_Media_Devices_IAudioRoutingManagerStatics<D>::GetDefault() const
    {
        void* audioRoutingManager{};
        check_hresult(WINRT_IMPL_SHIM(Windows::Phone::Media::Devices::IAudioRoutingManagerStatics)->GetDefault(&audioRoutingManager));
        return Windows::Phone::Media::Devices::AudioRoutingManager{ audioRoutingManager, take_ownership_from_abi };
    }
...
WINRT_EXPORT namespace winrt::Windows::Phone::Media::Devices
{
    ...
    {
        return impl::call_factory_cast<Windows::Phone::Media::Devices::AudioRoutingManager(*)(IAudioRoutingManagerStatics const&), AudioRoutingManager, IAudioRoutingManagerStatics>([](IAudioRoutingManagerStatics const& f) { return f.GetDefault(); });
    }
}
namespace std
{
