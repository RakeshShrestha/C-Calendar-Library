...
{
    template <typename D> WINRT_IMPL_AUTO(Windows::Foundation::Uri) consume_Windows_Phone_System_UserProfile_GameServices_Core_IGameService<D>::ServiceUri() const
    {
        void* value{};
        check_hresult(WINRT_IMPL_SHIM(Windows::Phone::System::UserProfile::GameServices::Core::IGameService)->get_ServiceUri(&value));
        return Windows::Foundation::Uri{ value, take_ownership_from_abi };
    }
    template <typename D> WINRT_IMPL_AUTO(Windows::Foundation::IAsyncOperation<Windows::Phone::System::UserProfile::GameServices::Core::GameServicePropertyCollection>) consume_Windows_Phone_System_UserProfile_GameServices_Core_IGameService<D>::GetGamerProfileAsync() const
    {
        void* operation{};
        check_hresult(WINRT_IMPL_SHIM(Windows::Phone::System::UserProfile::GameServices::Core::IGameService)->GetGamerProfileAsync(&operation));
        return Windows::Foundation::IAsyncOperation<Windows::Phone::System::UserProfile::GameServices::Core::GameServicePropertyCollection>{ operation, take_ownership_from_abi };
    }
    template <typename D> WINRT_IMPL_AUTO(Windows::Foundation::IAsyncOperation<Windows::Phone::System::UserProfile::GameServices::Core::GameServicePropertyCollection>) consume_Windows_Phone_System_UserProfile_GameServices_Core_IGameService<D>::GetInstalledGameItemsAsync() const
    {
        void* operation{};
        check_hresult(WINRT_IMPL_SHIM(Windows::Phone::System::UserProfile::GameServices::Core::IGameService)->GetInstalledGameItemsAsync(&operation));
        return Windows::Foundation::IAsyncOperation<Windows::Phone::System::UserProfile::GameServices::Core::GameServicePropertyCollection>{ operation, take_ownership_from_abi };
    }
    template <typename D> WINRT_IMPL_AUTO(Windows::Foundation::IAsyncOperation<hstring>) consume_Windows_Phone_System_UserProfile_GameServices_Core_IGameService<D>::GetPartnerTokenAsync(Windows::Foundation::Uri const& audienceUri) const
    {
        void* operation{};
        check_hresult(WINRT_IMPL_SHIM(Windows::Phone::System::UserProfile::GameServices::Core::IGameService)->GetPartnerTokenAsync(*(void**)(&audienceUri), &operation));
        return Windows::Foundation::IAsyncOperation<hstring>{ operation, take_ownership_from_abi };
    }
    template <typename D> WINRT_IMPL_AUTO(Windows::Foundation::IAsyncOperation<hstring>) consume_Windows_Phone_System_UserProfile_GameServices_Core_IGameService<D>::GetPrivilegesAsync() const
    {
        void* operation{};
        check_hresult(WINRT_IMPL_SHIM(Windows::Phone::System::UserProfile::GameServices::Core::IGameService)->GetPrivilegesAsync(&operation));
        return Windows::Foundation::IAsyncOperation<hstring>{ operation, take_ownership_from_abi };
    }
    ...
    {
        check_hresult(WINRT_IMPL_SHIM(Windows::Phone::System::UserProfile::GameServices::Core::IGameService)->GrantAchievement(achievementId));
    }
    ...
    {
        check_hresult(WINRT_IMPL_SHIM(Windows::Phone::System::UserProfile::GameServices::Core::IGameService)->GrantAvatarAward(avatarAwardId));
    }
    ...
    {
        check_hresult(WINRT_IMPL_SHIM(Windows::Phone::System::UserProfile::GameServices::Core::IGameService)->PostResult(gameVariant, static_cast<int32_t>(scoreKind), scoreValue, static_cast<int32_t>(gameOutcome), *(void**)(&buffer)));
    }
    template <typename D> WINRT_IMPL_AUTO(void) consume_Windows_Phone_System_UserProfile_GameServices_Core_IGameService2<D>::NotifyPartnerTokenExpired(Windows::Foundation::Uri const& audienceUri) const
    {
        check_hresult(WINRT_IMPL_SHIM(Windows::Phone::System::UserProfile::GameServices::Core::IGameService2)->NotifyPartnerTokenExpired(*(void**)(&audienceUri)));
    }
    ...
    {
        uint32_t status{};
        check_hresult(WINRT_IMPL_SHIM(Windows::Phone::System::UserProfile::GameServices::Core::IGameService2)->GetAuthenticationStatus(&status));
        return status;
    }
    template <typename D> WINRT_IMPL_AUTO(Windows::Foundation::IAsyncOperation<Windows::Foundation::IInspectable>) consume_Windows_Phone_System_UserProfile_GameServices_Core_IGameServicePropertyCollection<D>::GetPropertyAsync(param::hstring const& propertyName) const
    {
        void* operation{};
        check_hresult(WINRT_IMPL_SHIM(Windows::Phone::System::UserProfile::GameServices::Core::IGameServicePropertyCollection)->GetPropertyAsync(*(void**)(&propertyName), &operation));
...
WINRT_EXPORT namespace winrt::Windows::Phone::System::UserProfile::GameServices::Core
{
    ...
    {
        return impl::call_factory_cast<Windows::Foundation::Uri(*)(IGameService const&), GameService, IGameService>([](IGameService const& f) { return f.ServiceUri(); });
    }
    inline auto GameService::GetGamerProfileAsync()
    {
        return impl::call_factory_cast<Windows::Foundation::IAsyncOperation<Windows::Phone::System::UserProfile::GameServices::Core::GameServicePropertyCollection>(*)(IGameService const&), GameService, IGameService>([](IGameService const& f) { return f.GetGamerProfileAsync(); });
    }
    inline auto GameService::GetInstalledGameItemsAsync()
    {
        return impl::call_factory_cast<Windows::Foundation::IAsyncOperation<Windows::Phone::System::UserProfile::GameServices::Core::GameServicePropertyCollection>(*)(IGameService const&), GameService, IGameService>([](IGameService const& f) { return f.GetInstalledGameItemsAsync(); });
    }
    inline auto GameService::GetPartnerTokenAsync(Windows::Foundation::Uri const& audienceUri)
    {
    ...
    {
        return impl::call_factory_cast<Windows::Foundation::IAsyncOperation<hstring>(*)(IGameService const&), GameService, IGameService>([](IGameService const& f) { return f.GetPrivilegesAsync(); });
    }
    ...
    inline auto GameService::PostResult(uint32_t gameVariant, Windows::Phone::System::UserProfile::GameServices::Core::GameServiceScoreKind const& scoreKind, int64_t scoreValue, Windows::Phone::System::UserProfile::GameServices::Core::GameServiceGameOutcome const& gameOutcome, Windows::Storage::Streams::IBuffer const& buffer)
    {
    ...
    inline auto GameService::NotifyPartnerTokenExpired(Windows::Foundation::Uri const& audienceUri)
    {
