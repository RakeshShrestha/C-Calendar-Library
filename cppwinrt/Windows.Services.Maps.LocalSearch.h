...
WINRT_EXPORT namespace winrt::Windows::Services::Maps::LocalSearch
{
    ...
    inline auto LocalLocationFinder::FindLocalLocationsAsync(param::hstring const& searchTerm, Windows::Devices::Geolocation::Geocircle const& searchArea, param::hstring const& localCategory, uint32_t maxResults)
    {
    ...
    inline auto PlaceInfoHelper::CreateFromLocalLocation(Windows::Services::Maps::LocalSearch::LocalLocation const& location)
    {
