...
namespace winrt::impl
{
    ...
    template <typename H> struct delegate<Windows::System::Threading::Core::SignalHandler, H> final : implements_delegate<Windows::System::Threading::Core::SignalHandler, H>
    {
