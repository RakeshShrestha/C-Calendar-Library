...
namespace winrt::impl
{
    ...
    {
        void* result{};
        check_hresult(WINRT_IMPL_SHIM(Windows::UI::Composition::Diagnostics::ICompositionDebugSettings)->get_HeatMaps(&result));
        return Windows::UI::Composition::Diagnostics::CompositionDebugHeatMaps{ result, take_ownership_from_abi };
    }
