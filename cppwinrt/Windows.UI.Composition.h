...
namespace winrt::impl
{
    ...
    {
        bool value{};
        check_hresult(WINRT_IMPL_SHIM(Windows::UI::Composition::ICompositionCapabilities)->AreEffectsSupported(&value));
        return value;
    }
    template <typename D> WINRT_IMPL_AUTO(bool) consume_Windows_UI_Composition_ICompositionCapabilities<D>::AreEffectsFast() const
    {
        bool value{};
        check_hresult(WINRT_IMPL_SHIM(Windows::UI::Composition::ICompositionCapabilities)->AreEffectsFast(&value));
        return value;
    }
    ...
    {
        void* current{};
        check_hresult(WINRT_IMPL_SHIM(Windows::UI::Composition::ICompositionCapabilitiesStatics)->GetForCurrentView(&current));
        return Windows::UI::Composition::CompositionCapabilities{ current, take_ownership_from_abi };
    }
    ...
    {
        void* instance{};
        check_hresult(WINRT_IMPL_SHIM(Windows::UI::Composition::ICompositionEffectSourceParameterFactory)->Create(*(void**)(&name), &instance));
        return Windows::UI::Composition::CompositionEffectSourceParameter{ instance, take_ownership_from_abi };
    }
    ...
    {
        void* result{};
        check_hresult(WINRT_IMPL_SHIM(Windows::UI::Composition::ICompositionPathFactory)->Create(*(void**)(&source), &result));
        return Windows::UI::Composition::CompositionPath{ result, take_ownership_from_abi };
    }
    ...
    {
        void* action{};
        check_hresult(WINRT_IMPL_SHIM(Windows::UI::Composition::ICompositor5)->RequestCommitAsync(&action));
