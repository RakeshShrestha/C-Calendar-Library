...
{
    template <typename D> WINRT_IMPL_AUTO(int32_t) consume_Windows_UI_Core_Preview_ICoreAppWindowPreviewStatics<D>::GetIdFromWindow(Windows::UI::WindowManagement::AppWindow const& window) const
    {
        int32_t result{};
    ...
    template <typename D> WINRT_IMPL_AUTO(Windows::Foundation::Deferral) consume_Windows_UI_Core_Preview_ISystemNavigationCloseRequestedPreviewEventArgs<D>::GetDeferral() const
    {
        void* result{};
    ...
    template <typename D> WINRT_IMPL_AUTO(winrt::event_token) consume_Windows_UI_Core_Preview_ISystemNavigationManagerPreview<D>::CloseRequested(Windows::Foundation::EventHandler<Windows::UI::Core::Preview::SystemNavigationCloseRequestedPreviewEventArgs> const& handler) const
    {
    ...
    template <typename D> WINRT_IMPL_AUTO(Windows::UI::Core::Preview::SystemNavigationManagerPreview) consume_Windows_UI_Core_Preview_ISystemNavigationManagerPreviewStatics<D>::GetForCurrentView() const
    {
        void* loader{};
...
WINRT_EXPORT namespace winrt::Windows::UI::Core::Preview
{
    ...
    {
        return impl::call_factory_cast<Windows::UI::Core::Preview::SystemNavigationManagerPreview(*)(ISystemNavigationManagerPreviewStatics const&), SystemNavigationManagerPreview, ISystemNavigationManagerPreviewStatics>([](ISystemNavigationManagerPreviewStatics const& f) { return f.GetForCurrentView(); });
    }
}
namespace std
{
