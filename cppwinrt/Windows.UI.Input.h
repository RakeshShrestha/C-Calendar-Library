...
namespace winrt::impl
{
    ...
    {
        bool canBeDoubleTap{};
        check_hresult(WINRT_IMPL_SHIM(Windows::UI::Input::IGestureRecognizer)->CanBeDoubleTap(*(void**)(&value), &canBeDoubleTap));
    ...
    template <typename D> WINRT_IMPL_AUTO(winrt::event_token) consume_Windows_UI_Input_IGestureRecognizer<D>::Tapped(Windows::Foundation::TypedEventHandler<Windows::UI::Input::GestureRecognizer, Windows::UI::Input::TappedEventArgs> const& handler) const
    {
        ...
        check_hresult(WINRT_IMPL_SHIM(Windows::UI::Input::IGestureRecognizer)->add_Tapped(*(void**)(&handler), put_abi(pCookie)));
        return pCookie;
    }
    ...
    {
        WINRT_VERIFY_(0, WINRT_IMPL_SHIM(Windows::UI::Input::IGestureRecognizer)->remove_Tapped(impl::bind_in(cookie)));
    }
    ...
    {
        winrt::event_token pCookie{};
        check_hresult(WINRT_IMPL_SHIM(Windows::UI::Input::IGestureRecognizer)->add_RightTapped(*(void**)(&handler), put_abi(pCookie)));
        return pCookie;
    }
    ...
    {
        WINRT_VERIFY_(0, WINRT_IMPL_SHIM(Windows::UI::Input::IGestureRecognizer)->remove_RightTapped(impl::bind_in(cookie)));
    }
    ...
    {
        winrt::event_token pCookie{};
        check_hresult(WINRT_IMPL_SHIM(Windows::UI::Input::IGestureRecognizer)->add_Holding(*(void**)(&handler), put_abi(pCookie)));
        return pCookie;
    }
    ...
    {
        WINRT_VERIFY_(0, WINRT_IMPL_SHIM(Windows::UI::Input::IGestureRecognizer)->remove_Holding(impl::bind_in(cookie)));
    }
    ...
    {
        winrt::event_token pCookie{};
        check_hresult(WINRT_IMPL_SHIM(Windows::UI::Input::IGestureRecognizer)->add_Dragging(*(void**)(&handler), put_abi(pCookie)));
        return pCookie;
    }
    ...
    {
        WINRT_VERIFY_(0, WINRT_IMPL_SHIM(Windows::UI::Input::IGestureRecognizer)->remove_Dragging(impl::bind_in(cookie)));
    }
    ...
    {
        winrt::event_token pCookie{};
        check_hresult(WINRT_IMPL_SHIM(Windows::UI::Input::IGestureRecognizer)->add_ManipulationStarted(*(void**)(&handler), put_abi(pCookie)));
        return pCookie;
    }
    ...
    {
        WINRT_VERIFY_(0, WINRT_IMPL_SHIM(Windows::UI::Input::IGestureRecognizer)->remove_ManipulationStarted(impl::bind_in(cookie)));
    }
    ...
    {
        winrt::event_token pCookie{};
        check_hresult(WINRT_IMPL_SHIM(Windows::UI::Input::IGestureRecognizer)->add_ManipulationUpdated(*(void**)(&handler), put_abi(pCookie)));
        return pCookie;
    }
    ...
    {
        WINRT_VERIFY_(0, WINRT_IMPL_SHIM(Windows::UI::Input::IGestureRecognizer)->remove_ManipulationUpdated(impl::bind_in(cookie)));
    }
    ...
    {
        winrt::event_token pCookie{};
        check_hresult(WINRT_IMPL_SHIM(Windows::UI::Input::IGestureRecognizer)->add_ManipulationInertiaStarting(*(void**)(&handler), put_abi(pCookie)));
        return pCookie;
    }
    ...
    {
        WINRT_VERIFY_(0, WINRT_IMPL_SHIM(Windows::UI::Input::IGestureRecognizer)->remove_ManipulationInertiaStarting(impl::bind_in(cookie)));
    }
    ...
    {
        winrt::event_token pCookie{};
        check_hresult(WINRT_IMPL_SHIM(Windows::UI::Input::IGestureRecognizer)->add_ManipulationCompleted(*(void**)(&handler), put_abi(pCookie)));
        return pCookie;
    }
    ...
    {
        WINRT_VERIFY_(0, WINRT_IMPL_SHIM(Windows::UI::Input::IGestureRecognizer)->remove_ManipulationCompleted(impl::bind_in(cookie)));
    }
    ...
    {
        winrt::event_token pCookie{};
        check_hresult(WINRT_IMPL_SHIM(Windows::UI::Input::IGestureRecognizer)->add_CrossSliding(*(void**)(&handler), put_abi(pCookie)));
        return pCookie;
    }
    ...
    {
        WINRT_VERIFY_(0, WINRT_IMPL_SHIM(Windows::UI::Input::IGestureRecognizer)->remove_CrossSliding(impl::bind_in(cookie)));
    }
