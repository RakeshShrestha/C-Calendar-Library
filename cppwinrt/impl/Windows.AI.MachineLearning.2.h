...
WINRT_EXPORT namespace winrt::Windows::AI::MachineLearning
{
    ...
    struct __declspec(empty_bases) ImageFeatureValue : Windows::AI::MachineLearning::IImageFeatureValue,
        impl::require<ImageFeatureValue, Windows::AI::MachineLearning::ILearningModelFeatureValue>
    {
        ...
        static auto CreateFromVideoFrame(Windows::Media::VideoFrame const& image);
    };
    struct __declspec(empty_bases) LearningModel : Windows::AI::MachineLearning::ILearningModel,
        impl::require<LearningModel, Windows::Foundation::IClosable>
    {
        ...
        static auto LoadFromStorageFileAsync(Windows::Storage::IStorageFile const& modelFile);
        static auto LoadFromStreamAsync(Windows::Storage::Streams::IRandomAccessStreamReference const& modelStream);
        static auto LoadFromFilePath(param::hstring const& filePath);
        static auto LoadFromStream(Windows::Storage::Streams::IRandomAccessStreamReference const& modelStream);
        static auto LoadFromStorageFileAsync(Windows::Storage::IStorageFile const& modelFile, Windows::AI::MachineLearning::ILearningModelOperatorProvider const& operatorProvider);
        static auto LoadFromStreamAsync(Windows::Storage::Streams::IRandomAccessStreamReference const& modelStream, Windows::AI::MachineLearning::ILearningModelOperatorProvider const& operatorProvider);
        static auto LoadFromFilePath(param::hstring const& filePath, Windows::AI::MachineLearning::ILearningModelOperatorProvider const& operatorProvider);
        static auto LoadFromStream(Windows::Storage::Streams::IRandomAccessStreamReference const& modelStream, Windows::AI::MachineLearning::ILearningModelOperatorProvider const& operatorProvider);
    };
    struct __declspec(empty_bases) LearningModelBinding : Windows::AI::MachineLearning::ILearningModelBinding,
    ...
    struct __declspec(empty_bases) LearningModelSession : Windows::AI::MachineLearning::ILearningModelSession,
    ...
    struct __declspec(empty_bases) MapFeatureDescriptor : Windows::AI::MachineLearning::IMapFeatureDescriptor,
    ...
    struct __declspec(empty_bases) SequenceFeatureDescriptor : Windows::AI::MachineLearning::ISequenceFeatureDescriptor,
    ...
    struct __declspec(empty_bases) TensorBoolean : Windows::AI::MachineLearning::ITensorBoolean,
        impl::require<TensorBoolean, Windows::AI::MachineLearning::ILearningModelFeatureValue, Windows::AI::MachineLearning::ITensor, Windows::Foundation::IClosable, Windows::Foundation::IMemoryBuffer>
    {
        ...
        static auto CreateFromBuffer(array_view<int64_t const> shape, Windows::Storage::Streams::IBuffer const& buffer);
    };
    struct __declspec(empty_bases) TensorDouble : Windows::AI::MachineLearning::ITensorDouble,
    ...
    struct __declspec(empty_bases) TensorFeatureDescriptor : Windows::AI::MachineLearning::ITensorFeatureDescriptor,
    ...
    struct __declspec(empty_bases) TensorFloat : Windows::AI::MachineLearning::ITensorFloat,
    ...
    struct __declspec(empty_bases) TensorFloat16Bit : Windows::AI::MachineLearning::ITensorFloat16Bit,
    ...
    struct __declspec(empty_bases) TensorInt16Bit : Windows::AI::MachineLearning::ITensorInt16Bit,
    ...
    struct __declspec(empty_bases) TensorInt32Bit : Windows::AI::MachineLearning::ITensorInt32Bit,
    ...
    struct __declspec(empty_bases) TensorInt64Bit : Windows::AI::MachineLearning::ITensorInt64Bit,
    ...
    struct __declspec(empty_bases) TensorInt8Bit : Windows::AI::MachineLearning::ITensorInt8Bit,
    ...
    struct __declspec(empty_bases) TensorString : Windows::AI::MachineLearning::ITensorString,
    ...
    struct __declspec(empty_bases) TensorUInt16Bit : Windows::AI::MachineLearning::ITensorUInt16Bit,
    ...
    struct __declspec(empty_bases) TensorUInt32Bit : Windows::AI::MachineLearning::ITensorUInt32Bit,
    ...
    struct __declspec(empty_bases) TensorUInt64Bit : Windows::AI::MachineLearning::ITensorUInt64Bit,
    ...
    struct __declspec(empty_bases) TensorUInt8Bit : Windows::AI::MachineLearning::ITensorUInt8Bit,
