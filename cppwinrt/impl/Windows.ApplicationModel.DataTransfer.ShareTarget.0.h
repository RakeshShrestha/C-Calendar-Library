...
namespace winrt::impl
{
    ...
    struct consume_Windows_ApplicationModel_DataTransfer_ShareTarget_IQuickLink
    {
        ...
        [[nodiscard]] WINRT_IMPL_AUTO(Windows::Foundation::Collections::IVector<hstring>) SupportedDataFormats() const;
        [[nodiscard]] WINRT_IMPL_AUTO(Windows::Foundation::Collections::IVector<hstring>) SupportedFileTypes() const;
    };
    ...
    struct consume_Windows_ApplicationModel_DataTransfer_ShareTarget_IShareOperation
    {
        ...
        WINRT_IMPL_AUTO(void) ReportCompleted(Windows::ApplicationModel::DataTransfer::ShareTarget::QuickLink const& quicklink) const;
