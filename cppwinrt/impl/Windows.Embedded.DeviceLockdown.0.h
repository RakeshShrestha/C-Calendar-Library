...
namespace winrt::impl
{
    ...
    {
        WINRT_IMPL_AUTO(Windows::Foundation::Collections::IVectorView<winrt::guid>) GetSupportedLockdownProfiles() const;
        WINRT_IMPL_AUTO(winrt::guid) GetCurrentLockdownProfile() const;
        WINRT_IMPL_AUTO(Windows::Foundation::IAsyncAction) ApplyLockdownProfileAsync(winrt::guid const& profileID) const;
        WINRT_IMPL_AUTO(Windows::Embedded::DeviceLockdown::DeviceLockdownProfileInformation) GetLockdownProfileInformation(winrt::guid const& profileID) const;
    };
