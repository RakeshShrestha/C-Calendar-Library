...
WINRT_EXPORT namespace winrt::Windows::Media::Capture
{
    ...
    struct __declspec(empty_bases) ScreenCapture : Windows::Media::Capture::IScreenCapture
    {
        ScreenCapture(std::nullptr_t) noexcept {}
        ScreenCapture(void* ptr, take_ownership_from_abi_t) noexcept : Windows::Media::Capture::IScreenCapture(ptr, take_ownership_from_abi) {}
        static auto GetForCurrentView();
    };
    struct __declspec(empty_bases) SourceSuspensionChangedEventArgs : Windows::Media::Capture::ISourceSuspensionChangedEventArgs
    {
        SourceSuspensionChangedEventArgs(std::nullptr_t) noexcept {}
        SourceSuspensionChangedEventArgs(void* ptr, take_ownership_from_abi_t) noexcept : Windows::Media::Capture::ISourceSuspensionChangedEventArgs(ptr, take_ownership_from_abi) {}
    };
