...
namespace winrt::impl
{
    ...
    template <> inline constexpr auto& name_v<Windows::Media::Effects::SlowMotionEffectDefinition> = L"Windows.Media.Effects.SlowMotionEffectDefinition";
    ...
    template <> inline constexpr auto& name_v<Windows::Media::Effects::ISlowMotionEffectDefinition> = L"Windows.Media.Effects.ISlowMotionEffectDefinition";
    ...
    template <> inline constexpr guid guid_v<Windows::Media::Effects::ISlowMotionEffectDefinition>{ 0x35053CD0,0x176C,0x4763,{ 0x82,0xC4,0x1B,0x02,0xDB,0xE3,0x17,0x37 } };
    ...
    template <> struct abi<Windows::Media::Effects::ISlowMotionEffectDefinition>
    {
        struct __declspec(novtable) type : inspectable_abi
        {
    ...
    template <> struct consume<Windows::Media::Effects::ISlowMotionEffectDefinition>
    {
