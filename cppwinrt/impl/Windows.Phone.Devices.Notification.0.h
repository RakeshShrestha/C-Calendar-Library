...
namespace winrt::impl
{
    ...
    {
        WINRT_IMPL_AUTO(void) Vibrate(Windows::Foundation::TimeSpan const& duration) const;
    ...
    {
        WINRT_IMPL_AUTO(Windows::Phone::Devices::Notification::VibrationDevice) GetDefault() const;
    };
