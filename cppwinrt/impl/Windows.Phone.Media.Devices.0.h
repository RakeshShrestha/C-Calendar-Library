...
namespace winrt::impl
{
    ...
    template <> inline constexpr guid guid_v<Windows::Phone::Media::Devices::IAudioRoutingManager>{ 0x79340D20,0x71CC,0x4526,{ 0x9F,0x29,0xFC,0x8D,0x24,0x86,0x41,0x8B } };
    template <> inline constexpr guid guid_v<Windows::Phone::Media::Devices::IAudioRoutingManagerStatics>{ 0x977FB2A4,0x5590,0x4A6F,{ 0xAD,0xDE,0x6A,0x3D,0x0A,0xD5,0x82,0x50 } };
