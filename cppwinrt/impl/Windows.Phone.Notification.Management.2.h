...
WINRT_EXPORT namespace winrt::Windows::Phone::Notification::Management
{
    struct AccessoryManager
    {
        ...
        static auto ProcessTriggerDetails(Windows::Phone::Notification::Management::IAccessoryNotificationTriggerDetails const& pDetails);
        ...
        static auto AcceptPhoneCall(uint32_t phoneCallId, Windows::Phone::Notification::Management::PhoneCallAudioEndpoint const& endPoint);
        static auto AcceptPhoneCallWithVideo(uint32_t phoneCallId);
        static auto AcceptPhoneCallWithVideo(uint32_t phoneCallId, Windows::Phone::Notification::Management::PhoneCallAudioEndpoint const& endPoint);
        ...
        static auto MakePhoneCall(winrt::guid const& phoneLine, param::hstring const& phoneNumber, Windows::Phone::Notification::Management::PhoneCallAudioEndpoint const& endPoint);
        static auto MakePhoneCallWithVideo(winrt::guid const& phoneLine, param::hstring const& phoneNumber);
        static auto MakePhoneCallWithVideo(winrt::guid const& phoneLine, param::hstring const& phoneNumber, Windows::Phone::Notification::Management::PhoneCallAudioEndpoint const& endPoint);
        ...
        static auto PhoneCallAudioEndpoint(Windows::Phone::Notification::Management::PhoneCallAudioEndpoint const& value);
        [[nodiscard]] static auto PhoneCallAudioEndpoint();
        static auto SnoozeAlarm(winrt::guid const& alarmId);
        static auto SnoozeAlarm(winrt::guid const& alarmId, Windows::Foundation::TimeSpan const& timeSpan);
        static auto DismissAlarm(winrt::guid const& alarmId);
        static auto SnoozeReminder(winrt::guid const& reminderId);
        static auto SnoozeReminder(winrt::guid const& reminderId, Windows::Foundation::TimeSpan const& timeSpan);
        ...
        static auto PerformMediaPlaybackCommand(Windows::Phone::Notification::Management::PlaybackCommand const& command);
        ...
        static auto UpdateEmailReadStatus(Windows::Phone::Notification::Management::BinaryId const& messageEntryId, bool isRead);
    ...
    struct __declspec(empty_bases) AlarmNotificationTriggerDetails : Windows::Phone::Notification::Management::IAlarmNotificationTriggerDetails,
    ...
    struct __declspec(empty_bases) AppNotificationInfo : Windows::Phone::Notification::Management::IAppNotificationInfo
    {
    ...
    struct __declspec(empty_bases) BinaryId : Windows::Phone::Notification::Management::IBinaryId
    {
    ...
    struct __declspec(empty_bases) CalendarChangedNotificationTriggerDetails : Windows::Phone::Notification::Management::ICalendarChangedNotificationTriggerDetails
    {
    ...
    struct __declspec(empty_bases) CortanaTileNotificationTriggerDetails : Windows::Phone::Notification::Management::ICortanaTileNotificationTriggerDetails
    {
    ...
    struct __declspec(empty_bases) EmailAccountInfo : Windows::Phone::Notification::Management::IEmailAccountInfo
    {
    ...
    struct __declspec(empty_bases) EmailFolderInfo : Windows::Phone::Notification::Management::IEmailFolderInfo
    {
    ...
    struct __declspec(empty_bases) EmailNotificationTriggerDetails : Windows::Phone::Notification::Management::IEmailNotificationTriggerDetails,
    ...
    struct __declspec(empty_bases) EmailReadNotificationTriggerDetails : Windows::Phone::Notification::Management::IEmailReadNotificationTriggerDetails
    {
    ...
    struct __declspec(empty_bases) MediaControlsTriggerDetails : Windows::Phone::Notification::Management::IMediaControlsTriggerDetails
    {
    ...
    struct __declspec(empty_bases) MediaMetadata : Windows::Phone::Notification::Management::IMediaMetadata
    {
    ...
    struct __declspec(empty_bases) PhoneCallDetails : Windows::Phone::Notification::Management::IPhoneCallDetails
    {
    ...
    struct __declspec(empty_bases) PhoneLineDetails : Windows::Phone::Notification::Management::IPhoneLineDetails,
    ...
    struct __declspec(empty_bases) PhoneNotificationTriggerDetails : Windows::Phone::Notification::Management::IPhoneNotificationTriggerDetails
    {
    ...
    struct __declspec(empty_bases) ReminderNotificationTriggerDetails : Windows::Phone::Notification::Management::IReminderNotificationTriggerDetails,
    ...
    struct __declspec(empty_bases) SpeedDialEntry : Windows::Phone::Notification::Management::ISpeedDialEntry
    {
    ...
    struct __declspec(empty_bases) TextResponse : Windows::Phone::Notification::Management::ITextResponse
    {
    ...
    struct __declspec(empty_bases) ToastNotificationTriggerDetails : Windows::Phone::Notification::Management::IToastNotificationTriggerDetails,
    ...
    struct __declspec(empty_bases) VolumeInfo : Windows::Phone::Notification::Management::IVolumeInfo
    {
