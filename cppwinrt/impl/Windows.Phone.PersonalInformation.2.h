...
{
    struct __declspec(empty_bases) ContactAddress : Windows::Phone::PersonalInformation::IContactAddress
    {
    ...
    struct __declspec(empty_bases) ContactChangeRecord : Windows::Phone::PersonalInformation::IContactChangeRecord
    {
    ...
    struct __declspec(empty_bases) ContactInformation : Windows::Phone::PersonalInformation::IContactInformation
    {
        ...
        ContactInformation();
        static auto ParseVcardAsync(Windows::Storage::Streams::IInputStream const& vcard);
    };
    struct __declspec(empty_bases) ContactQueryOptions : Windows::Phone::PersonalInformation::IContactQueryOptions
    {
    ...
    struct __declspec(empty_bases) ContactQueryResult : Windows::Phone::PersonalInformation::IContactQueryResult
    {
    ...
    struct __declspec(empty_bases) ContactStore : Windows::Phone::PersonalInformation::IContactStore,
        impl::require<ContactStore, Windows::Phone::PersonalInformation::IContactStore2>
    {
        ...
        static auto CreateOrOpenAsync(Windows::Phone::PersonalInformation::ContactStoreSystemAccessMode const& access, Windows::Phone::PersonalInformation::ContactStoreApplicationAccessMode const& sharing);
    };
    ...
    struct __declspec(empty_bases) StoredContact : Windows::Phone::PersonalInformation::IStoredContact,
        impl::require<StoredContact, Windows::Phone::PersonalInformation::IContactInformation2>
    {
        ...
        explicit StoredContact(Windows::Phone::PersonalInformation::ContactStore const& store);
