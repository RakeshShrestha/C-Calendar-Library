...
namespace winrt::impl
{
    ...
    template <> inline constexpr auto& name_v<Windows::Phone::System::SystemProtection> = L"Windows.Phone.System.SystemProtection";
    template <> inline constexpr auto& name_v<Windows::Phone::System::ISystemProtectionStatics> = L"Windows.Phone.System.ISystemProtectionStatics";
    template <> inline constexpr auto& name_v<Windows::Phone::System::ISystemProtectionUnlockStatics> = L"Windows.Phone.System.ISystemProtectionUnlockStatics";
    template <> inline constexpr guid guid_v<Windows::Phone::System::ISystemProtectionStatics>{ 0x49C36560,0x97E1,0x4D99,{ 0x8B,0xFB,0xBE,0xFE,0xAA,0x6A,0xCE,0x6D } };
    template <> inline constexpr guid guid_v<Windows::Phone::System::ISystemProtectionUnlockStatics>{ 0x0692FA3F,0x8F11,0x4C4B,{ 0xAA,0x0D,0x87,0xD7,0xAF,0x7B,0x17,0x79 } };
