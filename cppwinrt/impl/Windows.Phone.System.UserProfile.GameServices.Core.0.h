...
namespace winrt::impl
{
    ...
    template <> inline constexpr guid guid_v<Windows::Phone::System::UserProfile::GameServices::Core::IGameService>{ 0x2E2D5098,0x48A9,0x4EFC,{ 0xAF,0xD6,0x8E,0x6D,0xA0,0x90,0x03,0xFB } };
    template <> inline constexpr guid guid_v<Windows::Phone::System::UserProfile::GameServices::Core::IGameService2>{ 0xD2364EF6,0xEA17,0x4BE5,{ 0x8D,0x8A,0xC8,0x60,0x88,0x5E,0x05,0x1F } };
    template <> inline constexpr guid guid_v<Windows::Phone::System::UserProfile::GameServices::Core::IGameServicePropertyCollection>{ 0x07E57FC8,0xDEBB,0x4609,{ 0x9C,0xC8,0x52,0x9D,0x16,0xBC,0x2B,0xD9 } };
