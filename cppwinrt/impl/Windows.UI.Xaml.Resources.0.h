...
namespace winrt::impl
{
    ...
    template <> struct abi<Windows::UI::Xaml::Resources::ICustomXamlResourceLoaderFactory>
    {
        struct __declspec(novtable) type : inspectable_abi
        {
    ...
    template <> struct abi<Windows::UI::Xaml::Resources::ICustomXamlResourceLoaderOverrides>
    {
        struct __declspec(novtable) type : inspectable_abi
        {
    ...
    template <> struct abi<Windows::UI::Xaml::Resources::ICustomXamlResourceLoaderStatics>
    {
        struct __declspec(novtable) type : inspectable_abi
        {
    ...
    template <> struct consume<Windows::UI::Xaml::Resources::ICustomXamlResourceLoader>
    {
